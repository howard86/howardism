...
export function buildTranslatePrompt(args: BuildTranslatePromptArgs): string {
  ...
  return [
    ...
    `- Include the line \`export { default as heroImage } from "../assets/<slug>.webp";\` BYTE-IDENTICAL to the source's heroImage line.`,
    "",
    "BYTE-IDENTICAL — DO NOT CHANGE",
    '- The `export { default as heroImage } from "../assets/<slug>.webp";` line.',
