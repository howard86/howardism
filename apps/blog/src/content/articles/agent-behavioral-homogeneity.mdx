...
- [Mind Viruses: Self-Propagating Ideas in Multi-Agent LLM Systems](https://arxiv.org/pdf/2608.10218) — Papadopoulos, Shah, Zimmerman & Lindsey, arXiv 2608.10218, 2026-08-10, `empirical`: Figure 8 left (per-model susceptibility) and Figure 4 right (infector- vs downstream-initiated collusion rates); both are chart-derived, the first with printed labels and the second read approximately. Full treatment on [Mind Viruses (Agent-to-Agent Idea Propagation)](/articles/mind-viruses)
