...
**A practitioner's number, placed on the taxonomy (Ng, August 2026).** [Andrew Ng](/articles/andrew-ng)'s public arithmetic against the job apocalypse — economists *"break it down into individual tasks and maybe AI could do… 30 40% of many jobs"* ([Andrew Ng: The Biggest Opportunities in AI Aren't Where You Think](https://www.youtube.com/watch?v=o-wv_szZ0V0), `practitioner-opinion`, attributed to [Erik Brynjolfsson](/articles/erik-brynjolfsson) and McAfee) — is a **theoretical-exposure** figure: what a model could do, not what is observed being done. The ordering above says where that puts it. Observed exposure runs far lower — [ATLAS](/articles/task-saturation) finds AI present in a median **21%** of a reached occupation's tasks — and reported exposure sits between. So the *"60% that a human does"* which Ng calls *"an economic complement"* is a lower bound on the human share today and an upper bound on where it settles; and his *"people that use AI will replace people that don't"* is a within-occupation reallocation that none of the four measures, computed per occupation, can see ([Task Crossover](/articles/task-crossover) is the nearest instrument). Which instrument the 30–40% came from he does not say, and the seven-instrument section below is the reason that matters.
...
- [GDPval Benchmark](/articles/gdpval-benchmark) — an instrument outside this page's four, and outside Steele & Cruz's seven, because it measures **delivered quality against the incumbent** rather than exposure at all: 44 occupations, tasks authored by professionals averaging 14 years in the role (4-year floor), scored as a blinded pairwise win rate. Its *selection* rule is nonetheless an exposure-measurement design choice, and a distinctive one — sectors first by GDP contribution (the nine each over 5% of Q2-2024 value added), then the five highest-wage occupations within each, filtered to those whose **weighted O\*NET digital-task share exceeds 0.60** under a GPT-4o classifier, with the classifier validated against the Acemoglu & Autor (2011) task-content framework (digital share rises with non-routine cognitive content and falls with routine and manual). That is theoretical exposure used as an *inclusion filter* rather than as an estimate, which makes GDPval's occupation list a fifth artifact this page's instruments can be scored against. Where every instrument here estimates how much of an occupation AI *touches*, GDPval asks whether the artifact beats the professional's — which makes its occupation ranking (counter and rental clerks, purchasing agents, IT systems managers, software developers near parity) a testable comparison against the eleven-occupations-in-twelve-slots disagreement below
...
- [GDPval: Evaluating AI Model Performance on Real-World Economically Valuable Tasks](https://arxiv.org/pdf/2510.04374) — Patwardhan et al. (19 authors, OpenAI), arXiv 2510.04374 v1, 2025-10-05, 29pp (`empirical`). Cited here for the selection methodology rather than the results: §2.1 and Table 1 (nine sectors over 5% of Q2-2024 GDP; five highest-wage predominantly-digital occupations each), §2.1 step 2 and A.7 (the GPT-4o O\*NET digital-task classifier at a 0.60 weighted threshold, the 831 → 761 occupation filtering, and the missing-data handling), and A.7.1 (validation against the Acemoglu & Autor 2011 five-score task-content framework). Full treatment and COI on [GDPval Benchmark](/articles/gdpval-benchmark)
...
- [Andrew Ng: The Biggest Opportunities in AI Aren't Where You Think](https://www.youtube.com/watch?v=o-wv_szZ0V0) — Andrew Ng interviewed by Marina Mogilko, *Silicon Valley Girl* (2026-08-28, `practitioner-opinion`): the 30–40%-of-tasks figure, attributed to Brynjolfsson and McAfee without a paper, used here only to place a practitioner's number on the taxonomy
