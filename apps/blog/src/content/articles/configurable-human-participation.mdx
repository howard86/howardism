...
description: "HAS-Bench (Wu et al.): human participation as a configurable
  benchmark variable (five-level agency scale × three interaction channels ×
  personas, 397 tasks) — equal partnership (A3) beats full automation by +8.4
  Pass@1 and recovers 65% of autonomy-failed tasks, but returns are
  configuration-dependent and diminish beyond A3; LLM-simulated human caveat."
tag: Concept
