...
description: "Borri-Liu-Tsyvinski: market-implied AI exposure built from 380T
  tokens of realized OpenRouter consumption — an AI Factor, rolling firm-level
  AI Betas, and a priced 64 bps/week long-short premium concentrated on
  frontier/paid use; the implied skill map is orthogonal to task-based exposure
  measures, and tool-call tokens rising to 52% signal an agentic economy."
tag: Concept
...
---
export { default as heroImage } from "../assets/market-priced-ai-exposure.webp";
...
## Connections
- [Task Saturation: Broad but Shallow AI Diffusion](/articles/task-saturation) — the usage-side counterpart to this page's skill map: ATLAS finds manual (5% of volume vs 28% of tasks) and interpersonal (9% vs 22%) work sharply under-represented while non-routine cognitive analytic work takes 65% of interactions — the same relational-vs-analytical split the AI Factor prices, arrived at from conversation logs instead of equity returns
- [The Household Production Boundary](/articles/household-production-boundary) — the value an asset-pricing instrument structurally cannot see: 86.5% of conversational AI usage lands on the unpaid side of the production boundary, where there is no revenue line for the market to capitalize

- [Exposure Taxonomy: Observed, Theoretical, Reported, Anticipated](/articles/exposure-taxonomy) — the primary methodological sibling: this is a **fifth, market-implied measure** on a different axis from the AEI's observed/theoretical/reported/anticipated four — realized-consumption + equity-price risk pricing, forward-looking and priced rather than a capability estimate. It doesn't close the "representative sample" gap; it reframes it (every instrument is skewed differently). That page now also carries **Steele & Cruz's seven-instrument head-to-head**, which rehabilitates this page's orthogonality result: the task-based measures barely agree with *each other*, so the &lt;2%-of-variance finding is a fact about the field's dispersion, not a mark against the market instrument
...
- [AI and Market Power](/articles/ai-and-market-power) — the accounting-side counterpart to this page's priced expectation: on French and Portuguese administrative data, AI-using firms show **no** markup advantage over 2011–2022 and no market-share rank gain, while equity markets pay 64.1 bps/week for AI exposure. Not a contradiction — an asset price capitalises *expected future* rents where a markup measures *realised* price-over-marginal-cost, on barely-overlapping populations. The striking agreement is on **distance to frontier**: the AI premium is priced in developed markets and absent in emerging ones, and OECD find the markup premium exists in ICT and nowhere else. Both instruments say AI's measurable rents currently sit where AI is the product
...
- [Helping People Choose Careers in the Age of AI](https://arxiv.org/pdf/2607.15506) — Steele & Cruz, arXiv 2607.15506 (2026-07-16), `empirical`. Cited here only for §4.4 + Fig. 6 (correspondence among seven exposure instruments), which contextualizes this paper's orthogonality result. Table parse warnings and a source-internal contradiction are recorded on [Exposure Taxonomy: Observed, Theoretical, Reported, Anticipated](/articles/exposure-taxonomy).
