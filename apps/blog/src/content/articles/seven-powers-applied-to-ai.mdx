...
---
export { default as heroImage } from "../assets/seven-powers-applied-to-ai.webp";
...
- [Anthropic's Boris Cherny: Why Coding Is Solved, and What Comes Next](https://www.youtube.com/watch?v=SlGRN8jh2RI)
- [Beyond Benchmarks 2026: Five Data Sets Grounded in the Real World](https://www.emcap.com/beyond-benchmarks-2026) — Emergence Capital, *Beyond Benchmarks 2026* (June 2026): AI-vendor consolidation (spend 2.2× / vendor count flat) as the switching-cost-*formation* counterpart to Boris's erosion thesis. Note: several tables in this PDF-derived raw have collapsed multi-value cells (the Core Four table stacks Top Decile over Top Quartile into one cell — `736% 184%`) — every figure quoted here comes from the report's prose bullets, not from a parsed table
