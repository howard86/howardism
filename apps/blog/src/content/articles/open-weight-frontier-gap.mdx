...
- [GDPval Benchmark](/articles/gdpval-benchmark) — the benchmark under the GDPval-AA Elo board this page differences: real professional deliverables scored as a win rate against 10-year experts across 44 occupations. Worth knowing what the 61-Elo agentic gap is a gap *at* — economically valuable knowledge work, not chat preference or coding tasks
