...
---
export { default as heroImage } from "../assets/software-3-0.webp";
...
- [Compute Allocator](/articles/compute-allocator) — deciding what's worth compute is the human role in a 3.0 stack
...
- [AI as Primary Author](/articles/ai-as-primary-author) — programming-in-English is the paradigm in which an AI can be the *author* of most code at all
...
- [Universal AI (AIXI)](/articles/universal-ai-aixi) — a paradigm-level cousin of "pretraining as resource-bounded universal compression"; both push the same general-method-over-structure logic to its theoretical floor
- [Latent vs. Deterministic Space](/articles/latent-vs-deterministic-space) — [Tan](/articles/garry-tan)'s practitioner rule for the open question below: put judgment in the model, state and constraints in code; MenuGen is the canonical wrong-side-of-the-boundary bug
- [OpenClaw](/articles/openclaw) — the installer example's subject, now with its own entity page
