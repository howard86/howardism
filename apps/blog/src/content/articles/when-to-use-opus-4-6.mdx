...
---
export { default as heroImage } from "../assets/when-to-use-opus-4-6.webp";
...
> **Staleness notice (2026-07-16).** This answer was compiled for Opus 4.6 in April 2026. Two
> generations have shipped since: [Claude Opus 4.7](/articles/claude-opus-4-7) and [Claude Opus 4.8](/articles/claude-opus-4-8) (2026-05-28, now
> Anthropic's general-access frontier), alongside the [Claude 5](/articles/claude-sonnet-5) family. The
> Addendum's advice to "keep using 4.6 until you have measurements on 4.7" is **superseded** — it was
> written when 4.7 was days old and 4.6 was still a live default; neither is true now.
>
> The underlying experiments (AgentOpt, Hakim) have **never been re-run on 4.7 or 4.8**, so rules
> #1–#5 are un-retested hypotheses about current models, not measured facts about them. What is
> model-independent is the *mechanism* — scale-dependent overthinking — and its two mitigations:
> route around it, or constrain output. Treat those as durable; treat the numbers as 4.6-era.
