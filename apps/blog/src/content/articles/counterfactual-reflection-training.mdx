...
---
export { default as heroImage } from "../assets/counterfactual-reflection-training.webp";
...
- [Introspective Coupling](/articles/introspective-coupling) — the methodological cousin: supervise a *counterfactual* about the model's own behavior ("would my answer change if this cue were removed?") and get a verbal channel causally coupled to that behavior, again without pressure on the trace in the target context
