...
- [Pilot-to-Production Gap](/articles/pilot-to-production-gap) — **the structural route to the same unowned outcome.** Kropp et al. locate the accountability leak in language (framing an agent as an "employee" costs −9pp of personal accountability, +44% escalation, −18% error catching, with no adoption gain); Anthropic × Accenture locate it in the org chart, reporting that **42% of organizations rely on shared IT-and-finance accountability with no single owner** for AI costs and outcomes (Accenture *Tokenomics*, September 2026, `vendor-claim`). Their prescribed fix is a named owner holding three non-substitutable powers — decision rights, escalation authority, executive backing — and the absence of any one is claimed to stall a programme. The two failures survive each other's fix: a named owner does not undo the framing effect on the individuals operating the system, and tool-framing discipline does not produce a budget owner
...
- [Deploying AI from pilot to production: A practical blueprint for CIOs and technical leaders](https://cdn.prod.website-files.com/6889473510b50328dbb70ae6/6aa46440db7c5ad962ef7ef2_Claude-Accenture-Deploying-AI-from-pilot-to-production-09112026%20(1).pdf) — *Deploying AI from pilot to production*, Anthropic × Accenture, 2026-09-11, 38pp, `vendor-claim`. Cited here only for the ownership-diffusion figure and the three-part decomposition of ownership. Full treatment and evidence limits on [Pilot-to-Production Gap](/articles/pilot-to-production-gap)
