...
description: "IETF draft-klrc-aiagent-auth's Agent Identity Management System:
  ...
  and plural in a fourth way as of MCP spec 2026-07-28, a de-facto protocol
  legislating its own OAuth client-registration rules under neither body while
  independently converging on Client ID Metadata Documents"
tag: Concept
