...
- [GDPval: Evaluating AI Model Performance on Real-World Economically Valuable Tasks](https://arxiv.org/pdf/2510.04374) — Patwardhan et al. (19 authors, OpenAI), arXiv 2510.04374 v1, 2025-10-05, 29pp (`empirical`). Cited here only for the contrasting selection instrument: §2.1 and Table 1 (nine sectors each over 5% of Q2-2024 GDP; five highest-wage predominantly-digital occupations per sector, 44 total, $3T in annual earnings), §2.1 step 2 and A.7 (the GPT-4o O\*NET digital-task classifier at a 0.60 weighted threshold, validated against Acemoglu & Autor 2011), and §3.1 Figure 5 for the win-rate range. Full treatment and COI on [GDPval Benchmark](/articles/gdpval-benchmark)
