...
- [The Automation–Optimism Link](/articles/automation-optimism-link) — the human-capital cost Ng attaches to the fear narrative (people give up on skills), the policy-side inverse of that page's usage-side link between delegation and optimism
