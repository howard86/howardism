...
import heroImage from "../(assets)/what-are-ai-tools.png";

export const meta = {
  date: "2026-04-10",
  title: "What Are AI Tools?",
  description: "Overview of AI tools landscape and categories",
  image: { src: heroImage, alt: "Illustration for What Are AI Tools?" },
  readingTime: 2,
  tag: "Essay",
};
...
- <Link href="/articles/llm-as-compiler-knowledge-base">LLM-as-Compiler Knowledge Base</Link> — architecture pattern for LLM-powered knowledge bases
