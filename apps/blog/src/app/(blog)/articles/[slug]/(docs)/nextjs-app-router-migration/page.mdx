...
description: As Next.js App Router structure becomes stable and claimed
  production-ready, I have been wondering how drastic changes it will bring to
  company projects. Hence starting the journey by migrating this blog to the new
  structure.
tag: Essay
readingTime: 4
imageAlt: cat is smiling
archived: true
---
export { default as heroImage } from "../(assets)/smiling-cat.png";
...
Error: Could not find the module "<project>/node_modules/.pnpm/next@13.4.10_@babel+core@7.22.9_react-dom@18.2.0_react@18.2.0/node_modules/next/dist/client/image-component.js#Image" in the React Client Manifest. This is probably a bug in the React Server Components bundler.
```
