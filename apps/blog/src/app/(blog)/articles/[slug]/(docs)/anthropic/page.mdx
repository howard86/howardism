...
- Chloe Li — Anthropic Fellows; lead author of Model Spec Midtraining paper
...
- Model Spec Midtraining — Anthropic-Fellows alignment training method; Anthropic Alignment Science direction
- Alignment Fine Tuning, Deliberative Alignment, Synthetic Document Finetuning — alignment-stack components Anthropic uses or studies
