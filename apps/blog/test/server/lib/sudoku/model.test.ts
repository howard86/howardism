...
describe("sudoku model", () => {
  describe("constructor", () => {
    ...
    beforeEach(() => {
      // prettier-ignore
      validInput = [
        9, 0, 0, 0, 0, 4, 6, 1, 0, 0, 0, 0, 0, 0, 2, 0, 0, 7, 0, 0, 3, 0, 0, 9,
        0, 0, 2, 0, 0, 0, 0, 0, 7, 4, 2, 6, 0, 0, 0, 0, 0, 0, 0, 0, 0, 4, 5, 2,
        6, 0, 0, 0, 0, 0, 8, 0, 0, 1, 0, 0, 2, 0, 0, 2, 0, 0, 7, 0, 0, 0, 0, 0,
        0, 6, 5, 4, 0, 0, 0, 0, 1,
      ];
    });
    ...
    it("should throw if any integer is above 9", () => {
      ...
      expect(() => new Sudoku(invalidInput)).toThrow(
        "Incorrect input with invalid values=[92]"
      );
    });
    ...
    it("should throw if any integer is below 0", () => {
      ...
      expect(() => new Sudoku(invalidInput)).toThrow(
        "Incorrect input with invalid values=[-5]"
      );
    });
    ...
    it("should throw if any number is float", () => {
      ...
      expect(() => new Sudoku(invalidInput)).toThrow(
        "Incorrect input with invalid values=[1.1]"
      );
    });
  });
  ...
  describe("getRow", () => {
    // prettier-ignore
    const validInput = [
      9, 0, 0, 0, 0, 4, 6, 1, 0, 0, 0, 0, 0, 0, 2, 0, 0, 7, 0, 0, 3, 0, 0, 9, 0,
      0, 2, 0, 0, 0, 0, 0, 7, 4, 2, 6, 0, 0, 0, 0, 0, 0, 0, 0, 0, 4, 5, 2, 6, 0,
      0, 0, 0, 0, 8, 0, 0, 1, 0, 0, 2, 0, 0, 2, 0, 0, 7, 0, 0, 0, 0, 0, 0, 6, 5,
      4, 0, 0, 0, 0, 1,
    ];
  ...
  describe("isSolved", () => {
    it("should return true if sudoku is solved", () => {
      ...
      const sudoku = new Sudoku(
        // prettier-ignore
        [
          4, 6, 2, 8, 1, 7, 9, 5, 3, 1, 8, 9, 2, 5, 3, 7, 6, 4, 7, 3, 5, 6, 9,
          4, 1, 2, 8, 8, 4, 7, 5, 3, 1, 6, 9, 2, 5, 9, 3, 7, 6, 2, 4, 8, 1, 6,
          2, 1, 9, 4, 8, 5, 3, 7, 9, 1, 4, 3, 8, 6, 2, 7, 5, 3, 7, 6, 1, 2, 5,
          8, 4, 9, 2, 5, 8, 4, 7, 9, 3, 1, 6,
        ]
      );
    ...
    it("should return false if sudoku is not solved", () => {
      ...
      const sudokuWithZero = new Sudoku(
        // prettier-ignore
        [
          9, 0, 0, 0, 0, 4, 6, 1, 0, 0, 0, 0, 0, 0, 2, 0, 0, 7, 0, 0, 3, 0, 0,
          9, 0, 0, 2, 0, 0, 0, 0, 0, 7, 4, 2, 6, 0, 0, 0, 0, 0, 0, 0, 0, 0, 4,
          5, 2, 6, 0, 0, 0, 0, 0, 8, 0, 0, 1, 0, 0, 2, 0, 0, 2, 0, 0, 7, 0, 0,
          0, 0, 0, 0, 6, 5, 4, 0, 0, 0, 0, 1,
        ]
      );
